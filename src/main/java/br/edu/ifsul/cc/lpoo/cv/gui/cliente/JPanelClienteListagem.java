...
public class JPanelClienteListagem  extends JPanel implements ActionListener {
    ...
    public JPanelClienteListagem(Controle controle){
    ...
    private void initComponents(){
        ...
        btnFiltrar.setActionCommand("filtrar_cliente");
        ...
        modeloTabela = new DefaultTableModel(new String[]{"CPF","Nome", "Data de Cadastro"},0);
        ...
        btnRemover.setActionCommand("remover_cliente");
